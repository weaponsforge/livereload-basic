...
Welcome to the **livereload-basic** repository! We're excited to have you contribute to creating to the development of a simple and accessible local development environment for static sites (HTML, CSS, JavaScript) with live reload.
...
>  **Before Submitting**
>
> Check if there are other similar [PRs](https://github.com/weaponsforge/livereload-basic/pulls).
>
> **New Feature**
>
...
2. **Clone Your Fork:** Clone your forked repository to your local machine using Git. This allows you to work on the files locally.
   ```sh
   git clone https://github.com/yourusername/livereload-basic.git
   ```
...
3. **Set Upstream Remote:** Add the original repository as an upstream remote to your local clone. This helps you to keep your fork up to date.
   ```sh
   git remote add upstream https://github.com/weaponsforge/livereload-basic.git
   ```
...
2. **Add Your Content:** Make your changes or additions to the project. Ensure JavaScript best practices and conventions to continue promoting a well-structured code base.
...
2. **Create a Pull Request (PR):** Go to the original **livereload-basic** repository on GitHub and create a new pull request. Base your PR on your feature branch and target the `"dev"` branch of the upstream repository.
...
2. **Relevance:** Content should be relevant to localhost **live reload** development environment using JavaScript.
...
4. **Respect:** Respect the structure and formatting of the existing project.

Thank you for contributing to the **livereload-basic** repository. Your efforts help in creating an accessible localhost development environment for static websites.
